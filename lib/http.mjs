...
/** İstekler arası minimum bekleme (ms). SEC "fair access" sınırı 10 istek/sn.
 *  400ms ≈ 2.5 istek/sn — hâlâ limitin çok altında ama ~1500 hisselik evreni
 *  Actions iş süresine sığdırır. Ortam değişkeniyle geçici olarak ayarlanabilir. */
const MIN_GAP_MS = Number(process.env.MIN_GAP_MS || 400);
